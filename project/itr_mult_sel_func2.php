		...
		for (var a_s_m = 0; a_s_m < ch_m_s; a_s_m++){
			if (document.getElementsByName('mult_sel_itr')[a_s_m].checked == true) {
				...
				if (obj.options[obj.selectedIndex].text == 'Аннулировано'){
					ids_itrs = ids_itrs + document.getElementsByName('mult_sel_itr')[a_s_m].id.substr(8) + '|';
				}
				if (obj.options[obj.selectedIndex].text == 'Завершено'){
					if (document.getElementById('mult_s_'+document.getElementsByName('mult_sel_itr')[a_s_m].id.substr(8)).options[0].text == 'Принято') ids_itrs = ids_itrs + document.getElementsByName('mult_sel_itr')[a_s_m].id.substr(8) + '|';
				...
				if (obj.options[obj.selectedIndex].text == 'Выполнено'){
					if ((obj.parentNode.parentNode.cells[6].innerText == cur_fio_us) && (document.getElementById('mult_s_'+document.getElementsByName('mult_sel_itr')[a_s_m].id.substr(8)).options[0].text == 'Новое')) ids_itrs = ids_itrs + document.getElementsByName('mult_sel_itr')[a_s_m].id.substr(8) + '|';
					if ((obj.parentNode.parentNode.cells[6].innerText == cur_fio_us) && (document.getElementById('mult_s_'+document.getElementsByName('mult_sel_itr')[a_s_m].id.substr(8)).options[0].text == 'Просмотрено')) ids_itrs = ids_itrs + document.getElementsByName('mult_sel_itr')[a_s_m].id.substr(8) + '|';
					if ((obj.parentNode.parentNode.cells[6].innerText == cur_fio_us) && (document.getElementById('mult_s_'+document.getElementsByName('mult_sel_itr')[a_s_m].id.substr(8)).options[0].text == 'Принято к исполнению')) ids_itrs = ids_itrs + document.getElementsByName('mult_sel_itr')[a_s_m].id.substr(8) + '|';
					if ((obj.parentNode.parentNode.cells[6].innerText == cur_fio_us) && (document.getElementById('mult_s_'+document.getElementsByName('mult_sel_itr')[a_s_m].id.substr(8)).options[0].text == 'На доработку')) ids_itrs = ids_itrs + document.getElementsByName('mult_sel_itr')[a_s_m].id.substr(8) + '|';
				}
