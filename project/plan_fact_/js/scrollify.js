...
function FixAction( tbl, fixRows, fixCols, ww, hh)
{
  // FixHeaderCol(gid('order_table'),2,0,100,100);

	FixHeaderCol(gid( tbl ), fixRows ,fixCols , ww, hh ) ;
}
...
function FixHeaderCol( tbl, fixRows, fixCols, ww, hh)
{
	...
	var cont = CEL('div');
	var tblHead = CEL('table');
	var tblCol = CEL('table');
	var tblFixCorner = CEL('table');
