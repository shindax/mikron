...
$analytic_report_acc = "<div id='accordion' role='tablist' aria-multiselectable='true'>";

$analytic_report_acc .= getNotifications( [
	PLAN_FACT_ORDER_COMPLETED
] );
$analytic_report_acc .= "</div>";
...
<li class='nav-item'>
<a class='nav-link ".( $tab == 'plan_fact' ? 'active' : '')."' data-toggle='tab' href='#plan-fact' role='tab' aria-controls='home' aria-selected='true'>".conv("План-факт")."</a>
</li>

<li class='nav-item'>
<a class='nav-link' data-toggle='tab' href='#analytic-report' role='tab' aria-controls='home' aria-selected='true'>".conv("Св. анал. отчет")."</a>
</li>

<li class='nav-item'>
<a class='nav-link ".( $tab == 'entrance_control' ? 'active' : '')."'  data-toggle='tab' 
href='#entrance-control' 
role='tab' 
aria-controls='home' 
aria-selected='true'>".conv("Листы входного контроля")."</a>
</li>

<li class='nav-item'>
<a class='nav-link ".( $tab == 'conf_request' ? 'active' : '')."' data-toggle='tab' href='#conf-request' role='tab' aria-controls='home' aria-selected='true'>".conv("Запрос на подтверждение")."</a>
</li>
<li class='nav-item'>
...
$str .= "<div class='tab-pane fade' id='analytic-report' role='tabpanel' aria-labelledby='home-tab'>$analytic_report_acc</div>";
