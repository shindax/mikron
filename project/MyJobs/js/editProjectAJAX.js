...
// ѕрив€зка обработчика нажати€ на строки с классом collapsed
    UI_adjust();
}
...
// ≈сли нажата€ строка не была ранее узлом "дерева", то она им становитс€ 
   ...
   // Ќазначение данных дл€ работы "дерева"
   row.attr({'name' : name },{'id' : id });
   // ќбработка нажатий на новую строку
