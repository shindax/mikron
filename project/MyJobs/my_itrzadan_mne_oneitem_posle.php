...
global $PROJECT_ORDER_DETAIL_PAGE_ID   ;
...
-function listen(){
  ...
  prepTabs = function (t){
	...
	history.replaceState(0, 'New page title', 'index.php?do=show&formid=$PROJECT_ORDER_DETAIL_PAGE_ID&id=' + idi);
  ...
  var itrclick = function (e) {
	...
	if (obj.checked==true){
		if (('$namm3'=='Новое') || ('$namm3'=='Просмотрено')) {
			  if (obj.id == 'itrstatus1') { if (confirm('Изменить статус?')) { document.location.href = 'index.php?do=show&formid=$PROJECT_ORDER_DETAIL_PAGE_ID&id=' + idi + '&p8=1&p9=1';} else { this.checked=this.checked==false;}}
			  if (obj.id == 'itrstatus5') { if (confirm('Изменить статус?')) { document.location.href = 'index.php?do=show&formid=$PROJECT_ORDER_DETAIL_PAGE_ID&id=' + idi + '&p8=5&p9=1';} else { this.checked=this.checked==false;}}
		...
		if ('$namm3'=='Принято к исполнению') {
			  if (obj.id == 'itrstatus2') { if (confirm('Изменить статус?')) { document.location.href = 'index.php?do=show&formid=$PROJECT_ORDER_DETAIL_PAGE_ID&id=' + idi + '&p8=2&p9=1';} else { this.checked=this.checked==false;}}
			  if (obj.id == 'itrstatus5') { if (confirm('Изменить статус?')) { document.location.href = 'index.php?do=show&formid=$PROJECT_ORDER_DETAIL_PAGE_ID&id=' + idi + '&p8=5&p9=1';} else { this.checked=this.checked==false;}}
		...
		if ('$namm3'=='Выполнено') {
			  if (obj.id == 'itrstatus3') { if (confirm('Изменить статус?')) { document.location.href = 'index.php?do=show&formid=$PROJECT_ORDER_DETAIL_PAGE_ID&id=' + idi + '&p8=3&p9=1';} else { this.checked=this.checked==false;}}
			  if (obj.id == 'itrstatus4') { if (confirm('Изменить статус?')) { document.location.href = 'index.php?do=show&formid=$PROJECT_ORDER_DETAIL_PAGE_ID&id=' + idi + '&p8=4&p9=1';} else { this.checked=this.checked==false;}}
			  if (obj.id == 'itrstatus5') { if (confirm('Изменить статус?')) { document.location.href = 'index.php?do=show&formid=$PROJECT_ORDER_DETAIL_PAGE_ID&id=' + idi + '&p8=5&p9=1';} else { this.checked=this.checked==false;}}
			  if (obj.id == 'itrstatus1') { obj.checked=false; alert ('Вы не можете изменить статус \"' + statuss + '\" на \"' + obj.parentNode.innerText + '\".');}
			  if (obj.id == 'itrstatus2') { obj.checked=false; alert ('Вы не можете изменить статус \"' + statuss + '\" на \"' + obj.parentNode.innerText + '\".');}
			  if (obj.id == 'itrstatus6') { obj.checked=false; alert ('Вы не можете изменить статус \"' + statuss + '\" на \"' + obj.parentNode.innerText + '\".');}
		...
		if ('$namm3'=='Принято') {
			  if (obj.id == 'itrstatus6') { if (confirm('Изменить статус?')) { document.location.href = 'index.php?do=show&formid=$PROJECT_ORDER_DETAIL_PAGE_ID&id=' + idi + '&p8=6&p9=1';} else { this.checked=this.checked==false;}}
			  if (obj.id == 'itrstatus5') { if (confirm('Изменить статус?')) { document.location.href = 'index.php?do=show&formid=$PROJECT_ORDER_DETAIL_PAGE_ID&id=' + idi + '&p8=5&p9=1';} else { this.checked=this.checked==false;}}
			  if (obj.id == 'itrstatus1') { obj.checked=false; alert ('Вы не можете изменить статус \"' + statuss + '\" на \"' + obj.parentNode.innerText + '\".');}
			  if (obj.id == 'itrstatus2') { obj.checked=false; alert ('Вы не можете изменить статус \"' + statuss + '\" на \"' + obj.parentNode.innerText + '\".');}
			  if (obj.id == 'itrstatus3') { obj.checked=false; alert ('Вы не можете изменить статус \"' + statuss + '\" на \"' + obj.parentNode.innerText + '\".');}
...
<script>
  $(function() 
  {
      if( print !== 0 )
      {
           ...
           $('.link').last().remove();           
           $( 'div,input' ).css( 'border', 'none' );
           $( '#title' ).attr( { 'align' : 'center','padding' : 'auto' } );
      }
  });
</script>    
