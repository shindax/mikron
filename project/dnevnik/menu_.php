<?php
$today = date("Ymd");
$name11 = dbquery("SELECT * FROM ".$db_prefix."db_resurs where (ID_users='".$user['ID']."') ");
...
if (db_adcheck('db_itr_vremitr')) { echo "<a href='index.php?do=show&formid=134'><b>Мониторинг заданий (заказы)</b></a><br>
<br><a href='index.php?do=show&formid=152'><b>Мониторинг заданий (остальн.)</b></a>";}
if (($user['ID'] == 1) or ($user['ID'] == 3) or ($user['ID'] == 16) or ($user['ID'] == 4)) {
