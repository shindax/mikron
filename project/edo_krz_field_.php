...
echo "<table id='new_krz_tblhead' style='display:none;'><tbody><tr class='first'>
	...
	<td class='Field' style='padding:2px 5px 8px 5px; border:1px solid black;'>".$user['IO']."</td>
	</tr><tr>
