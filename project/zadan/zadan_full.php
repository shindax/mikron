...
.coop_td div div .coop_a
{
	font-weight: bold;
}

.coop_td div div .coop_a:hover
{
	background: silver;	
}
...
.total_count, .norm_fact_span, .count
{
	font-weight: bold ;
}
	...
	function check_cur_zak(id_zak, obj)
	{
		...
		for (var ch_t_f_d=0; ch_t_f_d < (ch_ids_tree_dse.length-1); ch_t_f_d++)
		{
			...
			for (var ch_t_f_o=0; ch_t_f_o < (jv3_arr_full_tbl_1_spl.length-1); ch_t_f_o++)
			{
				...
				if(jv3_arr_full_tbl_3_spl[ch_t_f_o]==''){ jv3_arr_full_tbl_3_spl[ch_t_f_o]='0';}
				if(jv3_arr_full_tbl_6_spl[ch_t_f_o]==''){ jv3_arr_full_tbl_6_spl[ch_t_f_o]='0.00';}
				if(jv3_arr_full_tbl_7_spl[ch_t_f_o]==''){ jv3_arr_full_tbl_7_spl[ch_t_f_o]='0';}
				if(jv3_arr_full_tbl_8_spl[ch_t_f_o]==''){ jv3_arr_full_tbl_8_spl[ch_t_f_o]='0.00';}
				if(jv3_arr_full_tbl_9_spl[ch_t_f_o]==''){ jv3_arr_full_tbl_9_spl[ch_t_f_o]='0';}
				if(jv3_arr_full_tbl_10_spl[ch_t_f_o]==''){ jv3_arr_full_tbl_10_spl[ch_t_f_o]='0.00';}
				...
				if (ch_ids_tree_dse[ch_t_f_d]==cur_dse_op_dse){ zadel_op=(cur_vp_op_dse-jv3_arr_full_tbl_7_spl[ch_t_f_o]-jv3_arr_full_tbl_9_spl[ch_t_f_o]);}
				if (zadel_op !== 0) { zadel_op='<a target=\"_blank\" href=\"index.php?do=show&formid=116&&p5='+jv3_arr_full_tbl_1_spl[ch_t_f_o]+'&p6='+cur_id_op_dse+'&p3='+jv3_arr_full_tbl_7_spl[ch_t_f_o]+'&p4='+cur_vp_op_dse+'\"><b>'+zadel_op+'</b></a>';}
...
//			if ((jv3_arr_full_tbl_8_spl[ch_t_f_o]>0)||(jv3_arr_full_tbl_7_spl[ch_t_f_o]>0))
				...
				var coop = jv3_arr_full_tbl_18_spl[ch_t_f_o] > 0 ? jv3_arr_full_tbl_18_spl[ch_t_f_o] + '/' + jv3_arr_full_tbl_17_spl[ch_t_f_o] : '';
				...
				'<td class=\"Field coop_td\"><div><div><input class=\"add_count\"/><input class=\"comment\"/><button class=\"coop_send\" disabled>Кооп</button></div><div><a href=\"#\" class=\"coop_a\">' + coop + '</a></div></div></td>'+
		...
		if(str_names_dse_spl[str_f_s].indexOf(val.toLowerCase())!==-1){
			...
			for (var ch_t_f_o=0; ch_t_f_o < (jv4_arr_full_tbl_1_spl.length-1); ch_t_f_o++){
				...
				if ((jv4_arr_full_tbl_8_spl[ch_t_f_o]>0)||(jv4_arr_full_tbl_7_spl[ch_t_f_o]>0)) 
					{ 
//опора задняя
/*						if( jv4_arr_full_tbl_1_spl[ch_t_f_o] == 113093)
{
						console.log('1 : ' + jv4_arr_full_tbl_1_spl[ch_t_f_o])
						console.log('2 : ' + jv4_arr_full_tbl_2_spl[ch_t_f_o])
						console.log('3 : ' + jv4_arr_full_tbl_3_spl[ch_t_f_o])
						console.log('4 : ' + jv4_arr_full_tbl_4_spl[ch_t_f_o])
						console.log('5 : ' + jv4_arr_full_tbl_5_spl[ch_t_f_o])
						console.log('6 : ' + jv4_arr_full_tbl_6_spl[ch_t_f_o])
						console.log('7 : ' + jv4_arr_full_tbl_7_spl[ch_t_f_o])
						console.log('8 : ' + jv4_arr_full_tbl_8_spl[ch_t_f_o])
						console.log('9 : ' + jv4_arr_full_tbl_9_spl[ch_t_f_o])						

						console.log('10 : ' + jv4_arr_full_tbl_10_spl[ch_t_f_o])						

						console.log('11 : ' + jv4_arr_full_tbl_11_spl[ch_t_f_o])						

						console.log('12 : ' + jv4_arr_full_tbl_12_spl[ch_t_f_o])						

						console.log('14 : ' + jv4_arr_full_tbl_14_spl[ch_t_f_o])						

						console.log('15 : ' + jv4_arr_full_tbl_15_spl[ch_t_f_o])						

						console.log('16 : ' + jv4_arr_full_tbl_16_spl[ch_t_f_o])						
}*/
	...
	$.post(
            '/project/zadan/ajax.GetCooperationsCount.php',
            {
               operitems_id: operitems_id
                   ...
                   function( respond, textStaus, jqXHR )
                  {
                	if( operitems_id == 18937 )
    						console.log( operitems_id + ' : ' + respond )
                  	return respond ;
                  },
              );
