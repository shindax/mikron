...
for ( var str_f_s=0; str_f_s < str_names_dse_spl.length-1 ; str_f_s++)
{
	...
	if (jv2_arr_full_tbl_5_spl[str_ids_dse_spl[str_f_s]].toLowerCase().indexOf( val_lower_case )!==-1)
	{
		...
		// Çäåñü õðàíÿòñÿ id çàïèñè â operitems
		...
		for (var ch_t_f_o=0; ch_t_f_o < (jv4_arr_full_tbl_1_spl.length-1); ch_t_f_o++)
		{
			...
			'<td class="Field coop_td"><div><div><input class="add_count"/><input class="comment"/><button class="coop_send" disabled>Êîîï</button></div><div><a href="#" class="coop_a  cls2">' + coop + '</a></div></div></td>'+
	...
	if(str_names_dse_spl[str_f_s].indexOf( val_lower_case )!==-1)
	{
		...
		for (var ch_t_f_o=0; ch_t_f_o < (jv4_arr_full_tbl_1_spl.length-1); ch_t_f_o++){
			...
			'<td class="Field coop_td"><div><div><input class="add_count"/><input class="comment"/><button class="coop_send" disabled>Êîîï</button></div><div><a href="#" class="coop_a  cls3">' + coop + '</a></div></div></td>'+
