...
// find_text_inp1-5				
				if (jv4_arr_full_tbl_15_spl[ch_t_f_o]==0)
				{
					...
					'<td class="Field ord_td find_text_inp1">'+jv4_arr_full_tbl_3_spl[ch_t_f_o]+'<br>'+jv4_arr_full_tbl_6_spl[ch_t_f_o]+'</td>'+
					'<td class="Field ord_td find_text_inp2">'+js_vp_op+'</td>'+
					'<td class="Field ord_td find_text_inp3">'+js_ksz_op+'</td>'+
					'<td class="Field ord_td find_text_inp4">'+k_o_sht+'<br>'+k_o_nch+'</td>'+
					'<td class="Field ord_td find_text_inp5">'+zadel_op+'</td>'+
...
// find_text_inp6 - 10
				...
				if (jv4_arr_full_tbl_15_spl[ch_t_f_o]==0)
				{
					...
					{ 
						...
						'<td class="Field ord_td find_text_inp6">'+jv4_arr_full_tbl_3_spl[ch_t_f_o]+'<br>'+jv4_arr_full_tbl_6_spl[ch_t_f_o]+'</td>'+
						'<td class="Field ord_td find_text_inp7">'+js_vp_op+'</td>'+
						'<td class="Field ord_td find_text_inp8">'+js_ksz_op+'</td>'+
						'<td class="Field ord_td find_text_inp9">'+k_o_sht+'<br>'+k_o_nch+'</td>'+
						'<td class="Field ord_td find_text_inp10">'+zadel_op+'</td>'+
						'<td style="width:225px;" class="Field"><textarea class="textarea"  onchange=vote9(this,'+jv4_arr_full_tbl_1_spl[ch_t_f_o]+',this.value); value="'+jv4_arr_full_tbl_11_spl[ch_t_f_o]+'">'+jv4_arr_full_tbl_11_spl[ch_t_f_o]+
						'</textarea><input type="button" class="ok_but" value="ok" onclick="zapr_pp(this,'+arr2_ids_dse_ch[str_ids_dse_spl[str_f_s]]+','+str_ids_dse_spl[str_f_s]+','+jv4_arr_full_tbl_1_spl[ch_t_f_o]+');"></td>'+
...
// shindax 23.01.2019
					...
					// console.log(jv4_arr_full_tbl_9_spl[ch_t_f_o])

					js_ksz_op = 1 * jv4_arr_full_tbl_9_spl[ch_t_f_o]  <= -1 ?

					'<a target="_blank" href="index.php?do=show&formid=129&p3='+jv4_arr_full_tbl_1_spl[ch_t_f_o]+'"><b>'+( -1 * jv4_arr_full_tbl_9_spl[ch_t_f_o] ) +'<br>'+ ( -1 * jv4_arr_full_tbl_10_spl[ch_t_f_o] ) +'</b></a>'
					:
					'<a target="_blank" href="index.php?do=show&formid=129&p3='+jv4_arr_full_tbl_1_spl[ch_t_f_o]+'"><b>'+jv4_arr_full_tbl_9_spl[ch_t_f_o]+'<br>'+jv4_arr_full_tbl_10_spl[ch_t_f_o]+'</b></a>';										
					...
					'<td class="Field ord_td find_text_inp11"><span class="total_count">'+jv4_arr_full_tbl_3_spl[ch_t_f_o]+'</span><br><span class="norm_hours">'+jv4_arr_full_tbl_6_spl[ch_t_f_o]+'</span></td>'+
					'<td class="Field ord_td find_text_inp12">'+js_vp_op+'</td>'+
					'<td class="Field ord_td find_text_inp13">'+js_ksz_op+'</td>'+
					'<td class="Field ord_td find_text_inp14">'+k_o_sht+'<br>'+k_o_nch+'</td>'+
					'<td class="Field ord_td find_text_inp15">'+zadel_op+'</td>'+
					'<td style="width:225px;" class="Field"><textarea class="textarea" onchange=vote9(this,'+jv4_arr_full_tbl_1_spl[ch_t_f_o]+',this.value); value="'+jv4_arr_full_tbl_11_spl[ch_t_f_o]+'">'+jv4_arr_full_tbl_11_spl[ch_t_f_o]+
					'</textarea><input type="button" class="ok_but" value="ok" onclick="zapr_pp(this,'+arr2_ids_dse_ch[str_ids_dse_spl[str_f_s]]+','+str_ids_dse_spl[str_f_s]+','+jv4_arr_full_tbl_1_spl[ch_t_f_o]+');"></td>'+
					'<td style="width:50px; background:#'+clas_tr_br+';" class="Field"><a style="cursor:pointer;" onclick="add_op_in_sz('+jv4_arr_full_tbl_1_spl[ch_t_f_o]+',this)"><b style="'+stl_b_tr_pr+'" name="pr_cur_r_op_b">>>></b></a></td>'+
					'</tr>';
