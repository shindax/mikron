...
while ($resurs = mysql_fetch_array($zzz)) {
	...
	while ($zadan = mysql_fetch_array($zadanresults)) {
		...
		echo "<tr>\n";
		$opermore = "";
		echo "<td style='border-top:1px solid #fff'><td style='font-size:120%;' colspan='5'>".$opermore."<b style='font-size:100%;'>Примечание:</b>".FVal($zadan,"db_zadan","MORE")."</td><td colspan='6'><b>Причина невыполнения:</b><br>&nbsp;</td>\n";
		echo "</tr>\n";
	...
	if ($isstarted) {
		if ($plan_p2 == 0) {
			...
			$row_ind = $row_ind + 1;
			echo "<tr><td colspan='4' style='background:#ccc;'><b style='font-size:120%; float:right;'>Итого план Н/Ч:</b></td><td style='background:#ccc;'><b style='font-size:120%;'>".$itog_res."</b></td><td style='background:#ccc;'><b style='font-size:120%;'>".$plan_n1."</b></td><td colspan=6 style='background:#ccc;'><b style='font-size:120%;'>Коэф.: ".$coef_plan."</b></td></tr>";
		}
