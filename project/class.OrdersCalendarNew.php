...
class OrdersCalendar extends BaseOrdersCalendar
{
    private $day ;
    private $month ;
    private $year ;
    ...
    private function GetItemRow( $input_section )
    {
        ...
        foreach(  $input_section AS $section )
        {
            ...
            foreach( $section['items'] AS $item )
            {
                ...
                $str .= "<tr data-id='$order_id' class='item_row hidden' data-parent_id='$parent_id'><td class='field AL name'><span>" . $item['order_name'] ."</span><span> ( $order_id )</span></td>";
                $str .= "<td class='field legend'><div style='background:$color;'></div></td>";
              $str .= "
