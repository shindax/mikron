...
$zak_id = $_GET['id'];
$all_dses = $_GET['p1'];
//$all_dses = "15421|19946|";
$arr_all_dses = explode("|", $all_dses);
...
foreach($arr_all_dses as $kke_1 => $vva_1){ if ($vva_1 !== ""){
$dse_id = $vva_1;
...
<tr>
<td".$fld.$stl_s.$stl_c.$stl_b.$stl_e." colspan='4' rowspan='2'><b style='font-family:Times new roman; font-size:24pt; text-align:center;'>Технологическая карта</b></td>
...
<td".$fld.$stl_s.$stl_c.$stl_bl.$stl_bt.$stl_f_1.$stl_bg.$stl_e.">Номер<br>операции</td>
<td".$fld.$stl_s.$stl_c.$stl_bt.$stl_f_2.$stl_bg.$stl_e." colspan='3'>Наименование операции</td>
<td".$fld.$stl_s.$stl_c.$stl_bt.$stl_f_2.$stl_bg.$stl_e." colspan='3'>Оборудование (наименование, марка)</td>
<td".$fld.$stl_s.$stl_c.$stl_bt.$stl_bg.$stl_e." colspan='2'>Норма<br>на ед., мин</td>
<td".$fld.$stl_s.$stl_c.$stl_bt.$stl_bg.$stl_e." colspan='2'>Норма<br>на пз., мин</td>
<td".$fld.$stl_s.$stl_c.$stl_bt.$stl_bg.$stl_e.">На зак.<br>шт.</td>
<td".$fld.$stl_s.$stl_c.$stl_bt.$stl_br.$stl_bg.$stl_e.">На зак.<br>Н/Ч</td>
</tr>
<tr name='tr2_oper' id='tr2_oper_id_".$name_op['ID']."'>
<td".$fld.$stl_s.$stl_c.$stl_b."width:55px;".$stl_bg.$stl_f_2.$stl_e.">".$name_op['ORD']."</td>
<td".$fld.$stl_s.$stl_c.$stl_bb.$stl_bg.$stl_f_2.$stl_e." colspan='3'>".$arr_oper_tid[$name_oper_nam['TID']]." - ".$name_oper_nam['NAME']."</td>
<td".$fld.$stl_s.$stl_c.$stl_bb.$stl_bg.$stl_f_2.$stl_e." colspan='3'>".$name_park['NAME']." - ".$name_park['MARK']."</td>
<td".$fld.$stl_s.$stl_c.$stl_bb.$stl_bg.$stl_e." colspan='2'>".$name_op['NORM']."</td>
<td".$fld.$stl_s.$stl_c.$stl_bb.$stl_bg.$stl_e." colspan='2'>".$name_op['NORM_2']."</td>
<td".$fld.$stl_s.$stl_c.$stl_bb.$stl_bg.$stl_e.">".$name_op['NUM_ZAK']."</td>
<td".$fld.$stl_s.$stl_c.$stl_bb.$stl_br.$stl_bg.$stl_e.">".$name_op['NORM_ZAK']."</td>
</tr>";
if (($name_op['ID_user']!=='') and ($name_op['ID_user']!=='0')){
	...
	while ($name = mysql_fetch_array($result)){ 
		...
		<td".$fld.$stl_s.$stl_cl."min-width:322px;".$stl_e." colspan='2'>".$name['TXT']."</td>
		<td".$fld.$stl_s.$stl_c.$stl_bl."width:165px;".$stl_e.">".$name['INSTR_1']."</td>
		<td".$fld.$stl_s.$stl_c."width:165px;".$stl_e.">".$name['INSTR_2']."</td>
		<td".$fld.$stl_s.$stl_c.$stl_br."width:165px;".$stl_e.">".$name['INSTR_3']."</td>
...
foreach($avtor_arr as $eke_1 => $ava_1){
	$avtor_td = $avtor_td."<b>".$resurses_nam_arr[$ava_1]."</b><br>";
}
...
var next_ind;
var new_ind_tbl;
if (getComputedStyle(document.getElementsByName('MTK_perehod')[0]).height.substr(0, (getComputedStyle(document.getElementsByName('MTK_perehod')[0]).height.length-2))<965) {
	document.getElementsByName('MTK_perehod_div')[0].style.height=(965-getComputedStyle(document.getElementsByName('MTK_perehod')[0]).height.substr(0, (getComputedStyle(document.getElementsByName('MTK_perehod')[0]).height.length-2)));
}else{
...
function check_height_tbl(index_tbl, ch_full_h_f){
	if (getComputedStyle(document.getElementsByName('MTK_perehod')[index_tbl]).height.substr(0, (getComputedStyle(document.getElementsByName('MTK_perehod')[index_tbl]).height.length-2))<965) {
		document.getElementsByName('MTK_perehod_div')[index_tbl].style.height=(965-getComputedStyle(document.getElementsByName('MTK_perehod')[index_tbl]).height.substr(0, (getComputedStyle(document.getElementsByName('MTK_perehod')[index_tbl]).height.length-2)));
		next_ind = 1;
