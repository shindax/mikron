...
$operitems = dbquery("SELECT * FROM ".$db_prefix."db_operitems where  (ID='".$_GET["p0"]."')");
...
$zadres = dbquery("SELECT * FROM ".$db_prefix."db_zadan where  (ID_operitems='".$_GET["p0"]."') order by DATE, SMEN");

echo "Отчёт от ".date("d.m.Y H:i",mktime())."<br><br>";

echo "<h2>Сменные задания по операции</H2>";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	echo "<tr class='first'>";
		...
		echo "<td>".FVal($zad,"db_zadan","ID_resurs")."</td>";
	...
	echo "<tr class='first'>";
		echo "<td class='TAR' colspan='3'><b>Итого:</b></td>";
		echo "<td><b>$x1</b></td>";
		echo "<td><b>$x2</b></td>";
		echo "<td><b>$x3</b></td>";
		echo "<td><b>$x4</b></td>";
