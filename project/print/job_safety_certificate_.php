...
$row = mysql_fetch_assoc(dbquery("SELECT *,okb_db_special.NAME as `SpecialName`,`okb_db_safety_job`.`A10_1` FROM `okb_db_resurs`
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0 width=725
 ...
 <tr>
  ...
  style='font-family:"Times New Roman",serif'> № <?php echo $row['A10_1'] ?></span></p>
  </td>
 </tr>
 <tr style='height:19.05pt'>
  ...
  "Times New Roman",serif'>Выдано: <?php echo $row['FF'] . ' ' . $row['II'] . ' ' . $row['OO']; ?></span></p>
  </td>
 </tr>
 ...
 <tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=ConsPlusNonformat style='text-align:justify'><span style='font-family:
  "Times New Roman",serif'>Должность: <?php echo $row['SpecialName'] ?></span></p>
  </td>
 </tr>
 <tr>
  <td width=369 valign=top style='width:276.7pt;border:none;border-right:solid windowtext 1.0pt;
...
</select> <span id="year">&nbsp;&nbsp;20<input style="width:18px" type="text" value="<?php echo substr(0, 2, date('Y')); ?>"/>года</span> № <?php echo $row['A8_1']; ?></span></p>
  </td>
 </tr>
 <tr>
  <td width=369 valign=top style='width:276.7pt;border:none;border-right:solid windowtext 1.0pt;
 ...
 <tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=ConsPlusNonformat style='text-align:justify'>&quot;&nbsp;<input style="width:25px" type="text"/>&nbsp;&quot; <select style="width:70px;">
	<option>января</option>
	<option>февраля</option>
	<option>марта</option>
	<option>апреля</option>
	...
	<option>ноября</option>
	<option>декабря</option>
</select> <span style="margin-left:-10px;">20<input style="width:18px;font-size:12px;" type="text" value="<?php echo substr(0, 2, date('Y')); ?>"/>года</span></p>
  <p class=ConsPlusNonformat style='text-align:justify'><span style='font-family:
  "Times New Roman",serif'>            </span></p>
  </td>
 </tr>
