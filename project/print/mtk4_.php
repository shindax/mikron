...
echo ($i % 1 == 0 ? "<div class='pagebreak' style='clear:both'>" . "Отчёт от ".date("d.m.Y H:i",mktime())."<br><br>" : '')."<table class='PageTable'  style='width:1050px;border:2px solid #000' cellpadding='0' cellspacing='0'>";
