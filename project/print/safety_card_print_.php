...
0cm;margin-bottom:.0001pt'><img width=495 height=138 id="Рисунок 7"
...
<div style="margin:0 auto;text-align:center;"><small>(Ф.И.О., должность)</small></div><br/>
провела проверку знаний требований охраны труда работников по<!--br/-->
<div style="display:inline-block;border-bottom:1px solid #000;;width:100%;float:left;"><div style="float:left;margin-top:3px;">программе проверки знаний</div>
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=696
 ...
 <tr style='height:7.7pt'>
  ...
  style='font-size:10.0pt'>Ф. И. О.</span></b></p>
  </td>
  ...
  style='font-size:10.0pt'>Должность</span></b></p>
  </td>
  ...
  style='font-size:10.0pt'>Наименование подразделения (цех, участок, отдел, лаборатория, мастерская и т.д.)</span></b></p>
  </td>
  ...
  style='font-size:10.0pt'>Подпись проверяемого</span></b></p>
  </td>
 </tr>
