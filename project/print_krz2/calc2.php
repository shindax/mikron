...
function OutRT($num,$name,$D) {
	global $count;
	echo "
	<tr class='center'>
		<td class='num'>".$num."</td>
		<td colspan='2'>".$name."</td>
		<td colspan='5'>".FReal($D)."</td>
	</tr>
	";
}

function OutPred($num,$name,$D, $D2) {
	global $count;
	echo "
	<tr class='center'>
		<td class='num'>".$num."</td>
		<td colspan='2'>".$name."</td>
		<td colspan='5'>".FReal($D)." - ".FReal($D2)."</td>
	</tr>
	";
}
...
/////////////////////////////////////////////////////////////////////////
	...
	$DALL = (($D1+$D2)*$price)+$Dp3+$Dp4+$Dp5+$Dp6+$Dp7+$Dp8+$Dp9;
	$RURTONN = 0;
...
/////////////////////////////////////////////////////////////////////////
	...
	OutRT("12","Уровень прибыли на тонну, руб",$PRIB);
...
/////////////////////////////////////////////////////////////////////////
	...
	OutRT("13","Цена на тонну, руб",$RURTONN);
...
/////////////////////////////////////////////////////////////////////////
	...
	OutRC("14","Цена без НДС, руб",$DALL);

/////////////////////////////////////////////////////////////////////////
//
// Рекомендованный диапазон предоплаты
//
/////////////////////////////////////////////////////////////////////////
	
	$predopl = $Dp3 + $Dp4 + $Dp9 + $Dp5 + $Dp6 + $Dp7;
	$predopl2 = $predopl + 0.5*($DALL - $predopl);

	OutPred("15","Рекомендованный диапазон предоплаты, руб",$predopl,$predopl2);
?>