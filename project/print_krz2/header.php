...
<?php
	if ($print_mode == "off") {
		$rxxx = dbquery("SELECT ID_krz2, ID FROM ".$db_prefix."db_krz2det where (ID='".$_GET["id"]."')");
		$dxxx = mysql_fetch_array($rxxx);
		echo "<div class='links'>";
		echo "<a href='index.php?do=show&formid=33&id=".$dxxx["ID_krz2"]."'>Назад в КРЗ 2й круг</a><br>";
		echo "</div>";
	}
