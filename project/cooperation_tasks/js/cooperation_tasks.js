...
$( "#dialog-confirm" ).dialog({
      ...
      buttons: {
        "\u0423\u0434\u0430\u043B\u0438\u0442\u044C": function() 
        {
            ...
            $.post(
                "/project/cooperation_tasks/ajax.DeleteRecord.php",
                {
                    id  : id
                  },
                        function( data )
...
function add_cagent_btn_click ()
{
    ...
    $.post(
        "/project/cooperation_tasks/ajax.AddCagent.php",
        {
            coop_req_id  : req_id,
            user_id : user_id
          },
...
{
        $.post(
                "/project/cooperation_tasks/ajax.UpdateRecord.php",
                {
                    id  : id,
                    field : field, 
                    val : val
...
// {
//         $.post(
//                 "/project/cooperation_tasks/ajax.ClearSelected.php",
//                 {
//                     req_id  : req_id
//                   },
//                         function( data )
