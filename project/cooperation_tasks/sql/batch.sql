DROP TABLE IF EXISTS `okb_db_coop_tasks`;
CREATE TABLE IF NOT EXISTS `okb_db_coop_tasks` (
...
DROP TABLE IF EXISTS `okb_db_coop_pricing`;
CREATE TABLE IF NOT EXISTS `okb_db_coop_pricing` (
...
INSERT INTO `okb_db_coop_pricing` (`id`, `descr`, `note`, `timestamp`) VALUES
(1, 'Другое', '', '2018-03-02 03:47:01'),
(2, 'Согласно КП', '', '2018-03-02 03:47:01');

DROP TABLE IF EXISTS `okb_db_coop_task_state`;
CREATE TABLE IF NOT EXISTS `okb_db_coop_task_state` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `descr` varchar(50) NOT NULL,
  `note` varchar(250) NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
INSERT INTO `okb_db_coop_task_state` (`id`, `descr`, `note`, `timestamp`) VALUES
(1, 'Другое', '', '2018-03-02 03:47:01'),
