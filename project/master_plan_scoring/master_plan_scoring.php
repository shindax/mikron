<script type="text/javascript" src="/project/master_plan_scoring/js/constants.js"></script>
<script type="text/javascript" src="/project/master_plan_scoring/js/jquery.monthpicker.js"></script>
<script type="text/javascript" src="/project/master_plan_scoring/js/date.js"></script>
<script type="text/javascript" src="/project/master_plan_scoring/js/master_plan_scoring.js"></script>

<script type="text/javascript" src="/project/master_plan_scoring/js/jquery-ui.min.js"></script>

<link rel='stylesheet' href='/project/master_plan_scoring/css/bootstrap.min.css'>
