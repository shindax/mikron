...
// shindax 30.08.2016
//	$res1_1 = dbquery("SELECT COUNT(*) FROM ".$db_prefix."db_itrzadan where ((ID_users2='".$total2_1."') and (STATUS='Новое')) ");
	$res1_1 = dbquery("SELECT COUNT(*) FROM ".$db_prefix."db_itrzadan where ( ( ( ID_users2 LIKE '%$total2_1|%' ) OR ( ID_users2 = '$total2_1' )) and (STATUS='Новое') ) ");	
...
if ($show_itr > 0) {
    ...
    if( document.getElementById('scroll_left') != null && document.getElementById('scroll_right') != null )
...
if ('$block_id'!=='28'){
	window.onbeforeunload = function(evt){
		...
		if ('$cur_form'=='1507') { return 'Данное сообщение вызвано в случае случайного закрытия/ухода со страницы. Если же вы намеренно уходите/закрываете страницу, подтвердите.';}
//		if ('$cur_form'=='197') { return 'Данное сообщение вызвано в случае случайного закрытия/ухода со страницы. Если же вы намеренно уходите/закрываете страницу, подтвердите.';}
