...
class __TwigTemplate_5b341a532a262aaf8380e2396d70c10b1f3839c8a1ba1ac88118cbe250567be8 extends Twig_Template
{
    ...
    <fieldset>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["each_log"]) {
            ...
            echo "\"";
            // line 11
            echo ((($this->getAttribute($context["each_log"], "Log_name", array(), "array") == (isset($context["log"]) ? $context["log"] : null))) ? (" selected=\"selected\"") : (""));
            echo ">
                    ";
            // line 12
            echo twig_escape_filter($this->env, $this->getAttribute($context["each_log"], "Log_name", array(), "array"), "html", null, true);
            ...
            if ($this->getAttribute($context["each_log"], "File_size", array(), "array", true, true)) {
                ...
                echo ")
                        ";
                // line 15
                $context["full_size"] = ((isset($context["full_size"]) ? $context["full_size"] : null) + $this->getAttribute($context["each_log"], "File_size", array(), "array"));
                // line 16
                echo "                    ";
            }
            // line 17
...
";
    ...
    {
        return new Twig_Source("", "server/binlog/log_selector.twig", "/var/www/okbmikron/www/phpmyadmin/templates/server/binlog/log_selector.twig");
    }
}
